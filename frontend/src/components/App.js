...
function App() {
  ...
  const handleSigninSubmit = (email, password) => {
    auth.authorize(email, password)
      ...
      .catch(err => {
        alert(`Ошибка авторизации: ${err}. Проверьте корректность данных в полях Email и Пароль`)
      })
  }
  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      <div className="page">
        ...
        <EditProfilePopup isOpen={isEditProfilePopupOpen} onClose={handlePopupClose} onUserUpdate={handleUpdateUser} />
        <AddPlacePopup isOpen={isAddPlacePopupOpen} onClose={handlePopupClose} onAddPlaceSubmit={handleAddPlaceSubmit} />
        ...
        />
        <EditAvatarPopup isOpen={isEditAvatarPopupOpen} onClose={handlePopupClose} onAvatarUpdate={handleAvatarUpdate} />
